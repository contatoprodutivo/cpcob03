...
$_L['transaction_delete_successful'] =
    'Transa&ccedil;&atilde;o apagada com sucesso';
$_L['account_delete_successful'] = 'Conta apagada com sucesso';
$_L['transaction_update_successful'] =
    'Transa&ccedil;&atilde;o atualizada com sucesso';
...
$_L['account_title_length_error'] =
    'O nome da conta deve conter de 3 a 100 caracteres';
$_L['tr_delete_warning'] =
    'Opera&ccedil;&atilde;o de exclus&atilde;o n&atilde;o pode ser desfeita. Saldo atual das conta associadas ser&atilde;o ajustadas. ';
$_L['frequency_error'] =
    'Frequ&ecirc;ncia ou n&uacute;mero de pagamento inv&aacute;lido';
...
$_L['frequency_help'] =
    'Ex. Se voc&ecirc; optar por frequ&ecirc;ncia mensal, voc&ecirc; pode colocar o n&uacute;mero de pagamento 12. Isso vai repetir transa&ccedil;&atilde;o para os pr&oacute;ximos 12 meses.';
...
$_L['drag_drop_edit'] =
    'Arrastar e soltar os itens abaixo para reposicionamento. Clique em Editar.';
...
$_L['cat_del_help_txt'] =
    'Excluir categoria ir&aacute; renomear todas as opera&ccedil;&otilde;es desta categoria para &quot;Sem categoria&quot; ';
...
$_L['user_type_help'] =
    'Escolha o tipo de usu&aacute;rio &quot;Empregado&quot; para impossibilitar o acesso &agrave;s configura&ccedil;&otilde;es';
...
$_L['password_change_help'] =
    'Mantenha em branco para n&atilde;o alterar senha';
$_L['Edit_User'] = 'Editar usu&aacute;rio';
$_L['currency_help'] =
    'Mantenha-o em branco se voc&ecirc; n&atilde;o quiser mostrar c&oacute;digo de moeda';
...
$_L['Net Worth n Account Balances'] =
    'Patrim&ocirc;nio l&iacute;quido & Saldos de Conta';
...
$_L['Message Should be between 5 to 1000 characters'] =
    'A mensagem precisa conter de 5 a 1000 caracteres';
...
$_L['Set New Goal for Net Worth'] =
    'Definir nova meta para o patrim&ocirc;nio l&iacute;quido';
$_L['All Transactions at Date'] =
    'Todas as transa&ccedil;&otilde;es at&eacute; a data';
...
$_L['Invalid Username or Password'] =
    'Nome de usu&aacute;rio ou senha inv&aacute;lida';
...
$_L['Invalid Password Reset Key'] =
    'Chave de altera&ccedil;&atilde;o de senha inv&aacute;lida';
...
$_L['Optional Description help'] =
    'Descri&ccedil;&atilde;o opcional, ser&aacute; mostrada como ajuda';
$_L['Regular Expression Validation'] =
    'Express&atilde;o regular para valida&ccedil;&atilde;o';
$_L['Comma Separated List'] =
    'Use v&iacute;rgulas como separador das op&ccedil;&otilde;es da lista suspensa';
$_L['Show in View Invoice'] =
    'Mostrar na visualiza&ccedil;&atilde;o da fatura?';
$_L['Yes'] = 'Sim';
$_L['No'] = 'N&atilde;o';
...
$_L['This Name will be'] =
    'Esse nome ser&aacute; exibido no t&iacute;tulo, direitos autorais, etc.';
$_L['Theme'] = 'Tema';
$_L['Style'] = 'Estilo';
...
$_L['Enter to set the next invoice'] =
    'Digite para definir o pr&oacute;ximo n&uacute;mero da fatura, deve ser maior do que o atual, valor de incremento autom&aacute;tico';
$_L['Keep Blank for'] = 'Mantenha em branco para n&atilde;o alterar';
$_L['This will replace existing logo'] =
    'Isto ir&aacute; substituir o logo existente. Voc&ecirc; tamb&eacute;m pode alterar substituindo o arquivo';
$_L['User Interface'] = 'Interface do usu&aacute;rio';
$_L['Enable Page Loading Animation'] =
    'Ativar anima&ccedil;&atilde;o durante o carregamento da p&aacute;gina?';
...
$_L['to_enable_automation'] =
    'Para habilitar a execu&ccedil;&atilde;o dos recursos de automa&ccedil;&atilde;o, certifique-se de configurar uma tarefa cron para executar uma vez por dia. (por exemplo, 9:00).';
$_L['Create the following Cron Job using GET'] =
    'Crie o seguinte Cron Job usando GET:';
$_L['Or'] = ' ou ';
$_L['Create the following Cron Job using PHP'] =
    'Crie o seguinte Cron Job usando PHP:';
$_L['Create the following Cron Job using WGET'] =
    'Crie o seguinte Cron Job usando WGET:';
$_L['Generate Daily Accounting Snapshot'] =
    'Gerar diariamente um espelho das contas';
$_L['Generate Recurring Invoices'] = 'Gerar faturas recorrentes';
$_L['Enable Email Notifications'] =
    'Ativar notifica&ccedil;&otilde;es por e-mail';
$_L['Save Changes'] = 'Salvar altera&ccedil;&otilde;es';
$_L['Edit Categories'] = 'Editar categorias';
$_L['Deleting Categories will'] =
    'Excluir essa categoria ir&aacute; alterar todas as transa&ccedil;&otilde;es desta categoria para &quot;Sem categoria&quot;';
...
$_L['ref_example'] =
    'por exemplo c&oacute;digo da transa&ccedil;&atilde;o, n&uacute;mero do cheque.';
$_L['Recent Deposits'] = 'Recebimentos recentes';
$_L['Custom Fields'] = 'Campos personalizados';
$_L['Custom Fields Not Available'] =
    'Campos personalizados n&atilde;o est&atilde;o dispon&iacute;veis';
...
$_L['All Outgoing Email Will'] =
    'Todos envios de e-mails enviados a partir desse e-mail.';
...
$_L['drag_n_drop_help'] =
    'Arraste e solte os itens abaixo para reposicionamento. Clique em Editar.';
...
$_L['Invoice Payment Confirmation'] =
    'Confirma&ccedil;&atilde;o do pagamento da fatura';
$_L['Invoice Refund Confirmation'] =
    'Confirma&ccedil;&atilde;o do reembolso da fatura';
...
$_L['Keep it blank if currency code'] =
    'Mantenha em branco se n&atilde;o quiser exibir o s&iacute;mbolo da moeda';
$_L['Charset n Collation'] = 'Charset e Collation';
$_L['Set Charset n Collation'] =
    'Configurar o Charset e Collation das tabelas do banco';
$_L['Sign in'] = 'Entrar';
...
$_L['Reorder Payment Gateways'] =
    'Reordenar posi&ccedil;&atilde;o dos gateways de pagamento';
...
$_L['Choose User Type'] =
    'Escolha o tipo de usu&aacute;rio &quot;Empregado&quot; para desativar o acesso as &quot;Configura&ccedil;&otilde;es&quot;';
...
$_L['Transaction Added Successfully'] =
    'Transa&ccedil;&atilde;o adicionada com sucesso';
$_L['Invalid Number'] = 'N&uacute;mero inv&aacute;lido';
$_L['Logs has been deleted'] =
    'Hist&oacute;rico com mais de 30 dias ser&atilde;o removidos';
...
$_L['disabled_in_demo'] =
    'Essa op&ccedil;&atilde;o est&aacute; desabilida no modo de demonstra&ccedil;&atilde;o';
...
$_L['smtp_fields_error'] =
    'Usu&aacute;rio, senha e porta do SMTP s&atilde;o obrigat&oacute;rios';
...
$_L['cron_new_key'] =
    'Nova chave gerada. Por favor atualize as tarefas no CRON.';
$_L['cron_notification'] =
    'Por favor use um e-mail e v&aacute;lido para recever as notifica&ccedil;&otilde;es';
$_L['Select'] = 'Selecione';
$_L['Close'] = 'Fechar';
$_L['Update'] = 'Atualizar';
$_L['OK'] = 'Confirmar';
...
$_L['pdf_font_help_default'] =
    'Padr&atilde;o [Cria&ccedil;&atilde;o de PDF mais r&aacute;pido e com menos mem&oacute;ria]';
$_L['pdf_font_help_helvetica'] = 'Helvetica'; #Font name
$_L['pdf_font_help_dejavusanscondensed'] =
    'dejavusanscondensed [Incorporar fontes com suporte UTF8]'; # dejavusanscondensed is font name, you can either translate this or you may ignore this word from this string
...
$_L['quote_alias'] =
    'Criar novo or&ccedil;amento / proposta / cota&ccedil;&atilde;o';
...
$_L['quote_number_help'] =
    'Mantenha-o em branco para gerar automaticamente o n&uacute;mero do or&ccedil;amento';
$_L['invoice_number_help'] =
    'Mantenha-o em branco para gerar automaticamente o n&uacute;mero da fatura';
...
$_L['Admin:Password Change Request'] =
    'Adminustrador - Solicita&ccedil;&atilde;o de altera&ccedil;&atilde;o de senha';
$_L['Admin:New Password'] = 'Adminustrador - Nova senha';
$_L['Invoice:Invoice Payment Reminder'] =
    'Fatura - Lembrete de pagamento de fatura';
$_L['Invoice:Invoice Overdue Notice'] = 'Fatura - Aviso de fatura vencida';
$_L['Invoice:Invoice Payment Confirmation'] =
    'Fatura - Confirma&ccedil;&atilde;o do pagamento da fatura';
$_L['Invoice:Invoice Refund Confirmation'] =
    'Fatura - Confirma&ccedil;&atilde;o de restitui&ccedil;&atilde;o da fatura';
...
$_L['Quote Deleted Successfully'] =
    'Or&ccedil;amento exclu&iacute;do com sucesso';
$_L['Create New Quote'] = 'Criar novo or&ccedil;amento';

# V3.0.0

$_L['notice_email_as_username'] =
    'Por favor use um e-mail v&aacute;lido como nome de usu&aacute;rio';
$_L['API'] = 'API';
...
$_L['cron_invoice_created'] =
    'CRON Job - Enviar automaticamente Invoice Criado Email';
...
$_L['Send Client Signup Email'] =
    'Defina Sim para enviar Cliente Inscri&ccedil;&atilde;o e-mail.';
$_L['Profile'] = 'Perfil';
...
$_L['Currency Example'] =
    'Moeda Código ISO, por exemplo. USD, GBP, INR etc ...';
